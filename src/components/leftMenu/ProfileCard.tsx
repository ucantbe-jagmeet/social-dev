  ...
  return (
    <div className="p-4 bg-white rounded-lg shadow-md text-sm flex flex-col gap-6">
      ...
      <div className="h-20 flex flex-col gap-2 items-center">
        <span className="font-semibold">Jagmeet Singh</span>
        <div className="flex items-center gap-4">
          <div className="flex">
            <Image
              src="https://images.pexels.com/photos/13812367/pexels-photo-13812367.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
              alt=""
              width={12}
              height={12}
          ...
          <span className="text-xs text-gray-500">2198 Followers</span>
        </div>
        <Link href={`/`}>
